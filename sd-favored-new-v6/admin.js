        ...
        snapshot.forEach(docSnap => {
            ...
            if (o.posX !== undefined && designBtn) {
                ...
                designBtn.onclick = () => {
                    ...
                    const proofText = document.getElementById('adminPreviewText');
                    const rot = o.engravingRotation || 0;
                    proofText.innerText = o.personalization || o.engravingText || "No text";
                    proofText.style.fontSize = (o.engravingSize || 30) + "px";
                
                    // Recreate the exact position using the saved numbers
                    proofText.style.transform = `translate(calc(-50% + ${o.posX}px), calc(-50% + ${o.posY}px)) rotate(${rot}deg)`;
                
                    // Load the Font
                    const font = o.engravingFont || "Arial";
                    proofText.style.fontFamily = `"${font}", sans-serif`;
                
                    // Dynamic Font Fetcher for Admin
                    if (font !== "Arial") {
