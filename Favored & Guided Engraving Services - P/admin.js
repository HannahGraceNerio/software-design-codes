...
// =========================================
// FIXED SPOTLIGHT ENGINE
// =========================================

// 1. Compression Helper: Shrinks photos to fit in the 1MB database limit
async function compressImage(base64Str) {
    return new Promise((resolve) => {
        ...
        img.onload = () => {
            ...
            // Export as JPEG at 0.6 quality (saves ~90% space)
            resolve(canvas.toDataURL('image/jpeg', 0.6));
        };
    });
}

// 2. Render Grid: Displays the photos in your admin panel
...
// 3. Upload Listener: Handles 10MB limit and database sync
...
if (spotlightInput) {
    spotlightInput.addEventListener('change', async (e) => {
        ...
        // CHECK 10MB LOCAL SELECTION LIMIT
...
// =========================================
// FIXED MOBILE NAVIGATION ACTIVE STATE FOR ADMIN
// =========================================

// Override the existing showAdminSection function
...
// Function to update admin mobile nav active states
...
// Helper function to determine current admin section
...
// Enhance the existing DOMContentLoaded event in admin.js
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (hamburgerBtn && mobileMenu && closeMenuBtn && menuOverlay) {
        // Open menu - highlight current section
